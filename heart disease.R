...
hist(heart_data$chol,col = "red",main = "Serum chol Level", ylab = "no. of individuals", xlab = "chol Level")
hist(heart_disease$chol,col = "red",main = "Serum chol Level", ylab = "no. of individuals", xlab = "chol Level")
hist(no_disease$chol,col = "red",main = "Serum chol Level", ylab = "no. of individuals", xlab = "chol Level")
